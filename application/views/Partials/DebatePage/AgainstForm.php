...
?>
<div class="single-blog card row against">
    ...
    <form method="post" action="<?php echo base_url(); ?>index.php/Debates/AgainstComment/<?php echo $debateId ?>" class="contact-form col-sm-9">
